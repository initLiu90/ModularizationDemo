...
public class Module2Lifecycle implements IModuleLifecycle {
    ...
    public void onCreate() {
        ((ApiServiceManager) BaseApplication.sApplication.getAppRuntime().getManager(AppRuntime.API)).addApiService(IMode2.class, Mode2ServiceImpl.class);
    }

    @Override
    public void onStop() {
        ((ApiServiceManager) BaseApplication.sApplication.getAppRuntime().getManager(AppRuntime.API)).removeApiService(IMode2.class);
    }
}
